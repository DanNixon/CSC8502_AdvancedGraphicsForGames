...
const std::vector<std::string> ISystemMonitor::METRIC_NAMES = {
    "Total Physical Memory (MB)", "Used Physical Memory (MB)", "Process Used Physical Memory (MB)",
    "Peak Process Used Physical Memory (MB)", "Total Virtual Memory (MB)", "Used Virtual Memory (MB)",
    "Process Used Virtual Memory (MB)", "Peak Process Used Virtual Memory (MB)", "Process CPU Usage",
    "Interval Averaged FPS", "Interval Averaged ms/Frame"};
