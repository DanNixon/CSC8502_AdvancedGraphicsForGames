...
public:
  ...
  */
  float GetParticleVariance()
  {
    return particleVariance;
  }
  void SetParticleVariance(float variance)
  {
  ...
  */
  int GetLaunchParticles()
  {
    return numLaunchParticles;
  }
  void SetLaunchParticles(int num)
  {
    numLaunchParticles = num;
  }
